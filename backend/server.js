...
app.use((req, res, next) => {
  if (req.hostname === 'radhikagencies.com') {
    return res.redirect(301, `https://www.radhikagencies.com${req.url}`);
  }
  next();
});
// 2. Strip trailing slashes for clean canonical URLs (e.g. /about.html/ -> /about.html)
app.use((req, res, next) => {
